...
export const removeScaner = params => { return new Request().post(`${SEVER_HOST}scanTheManage/removeScanThe`, params) }
...
export const sanqr = params => { return new Request().post(`${SEVER_HOST}/scanTheManage/sanqr`,params)}
...
export const getStudentInfor = params => { return new Request().post(`${SEVER_HOST}analysisStudent/getStudentInfor`,params, {
    'Content-Type': 'application/x-www-form-urlencoded'
  })}
...
export const GetScanTheList = params => { return new Request().post(`${SEVER_HOST}scanTheManage/getScanTheList`, params) }
